...
def main():    
    ...
    rpc_url = os.getenv("RPC_URL_ETHEREUM_TESTNET")
    if not rpc_url:
        print("RPC_URL_ETHEREUM_TESTNET not found in the env")
        return
    ...
    if not w3.is_connected():
        print("Failed to connect to the Ethereum node using RPC_URL_ETHEREUM_TESTNET.")
        return
