...
func slr_main{
    ...
    %{
        segments.write_arg(ids.array, [
               2, 1 * 18446744073709551616, 0, 2 * 18446744073709551616, 0, 2, 3 *18446744073709551616, 0, 5 * 18446744073709551616, 0, 10 * 18446744073709551616, 0
           ])
    %}
