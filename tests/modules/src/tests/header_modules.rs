...
async fn test_modules_get_state_root() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_state_root.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
...
async fn test_modules_get_transaction_root() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_transaction_root.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
...
async fn test_modules_get_receipt_root() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_receipt_root.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
...
async fn test_modules_get_difficulty() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_difficulty.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
...
async fn test_modules_get_gas_limit() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_gas_limit.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
...
async fn test_modules_get_base_fee_per_gas() {
    run(serde_json::from_slice(include_bytes!(
        "../../../../target/dev/modules_header_get_base_fee_per_gas.compiled_contract_class.json"
    ))
    .unwrap())
    .await
}
