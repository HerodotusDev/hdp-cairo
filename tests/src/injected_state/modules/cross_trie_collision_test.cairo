...
mod cross_trie_collision_test {
    ...
    pub fn main(ref self: ContractState, hdp: HDP) -> Array<felt252> {
        ...
        let trie_root_0 = hdp
            .injected_state
            .read_injected_state_trie_root('collision_trie_0')
            .unwrap();
        let trie_root_1 = hdp
            .injected_state
            .read_injected_state_trie_root('collision_trie_1')
            .unwrap();
        let trie_root_2 = hdp
            .injected_state
            .read_injected_state_trie_root('collision_trie_2')
            .unwrap();
