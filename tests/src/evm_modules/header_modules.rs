...
async fn test_tests_evm_get_number_multi_evm_chains() {
    ...
    run(
        serde_json::from_slice(include_bytes!(
            "../../../target/dev/tests_evm_header_get_number_multi_evm_chains.compiled_contract_class.json"
        ))
        .unwrap(),
        InjectedState::default(),
    )
...
async fn test_tests_evm_get_requests_hash() {
    ...
    run(
        serde_json::from_slice(include_bytes!(
            "../../../target/dev/tests_evm_header_get_requests_hash.compiled_contract_class.json"
        ))
        .unwrap(),
        InjectedState::default(),
    )
