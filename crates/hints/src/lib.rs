...
pub fn hints() -> HashMap<String, HintImpl> {
    ...
    hints.insert(segments::MMR_METAS_LEN_KECCAK_COUNTER.into(), segments::mmr_metas_len_keccak_counter);
    hints.insert(segments::MMR_METAS_LEN_POSEIDON_COUNTER.into(), segments::mmr_metas_len_poseidon_counter);
    ...
    hints.insert(verifiers::evm::header_verifier::HINT_AP_HEADER_IS_KECCAK.into(), verifiers::evm::header_verifier::hint_ap_header_is_keccak);
    hints.insert(verifiers::evm::header_verifier::HINT_AP_HEADER_IS_POSEIDON.into(), verifiers::evm::header_verifier::hint_ap_header_is_poseidon);
    hints.insert(verifiers::evm::header_verifier::HINT_ENTER_SCOPE_HEADER_WITH_MMR.into(), verifiers::evm::header_verifier::hint_enter_scope_header_with_mmr);
    ...
    hints.insert(verifiers::evm::header_verifier::HINT_MMR_PATH_POSEIDON.into(), verifiers::evm::header_verifier::hint_mmr_path_poseidon);
    hints.insert(verifiers::evm::header_verifier::HINT_RLP_BYTE_LEN.into(), verifiers::evm::header_verifier::hint_rlp_byte_len);
    ...
    hints.insert(verifiers::evm::header_verifier::HINT_SET_RLP.into(), verifiers::evm::header_verifier::hint_set_rlp);
    ...
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_META_PEAKS_LEN.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_meta_peaks_len);
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_META_ROOT_HIGH.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_meta_root_high);
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_META_ROOT_LOW.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_meta_root_low);
    ...
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_META_SIZE.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_meta_size);
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_PEAKS_KECCAK.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_peaks_keccak);
    hints.insert(verifiers::evm::mmr_verifier::HINT_HEADERS_WITH_MMR_PEAKS_POSEIDON.into(), verifiers::evm::mmr_verifier::hint_headers_with_mmr_peaks_poseidon);
    ...
    hints.insert(verifiers::starknet::header_verifier::HINT_MMR_PATH_POSEIDON.into(), verifiers::starknet::header_verifier::hint_mmr_path_poseidon);
    hints.insert(verifiers::starknet::header_verifier::HINT_SET_FIELDS.into(), verifiers::starknet::header_verifier::hint_set_fields);
