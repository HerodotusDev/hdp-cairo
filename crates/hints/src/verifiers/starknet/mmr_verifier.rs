...
/* Keccak peaks writer for Starknet: writes Vec<Bytes>[32] into memory as contiguous Uint256 (low, high) pairs. */
pub const HINT_HEADERS_WITH_MMR_PEAKS_KECCAK: &str = "segments.write_arg(ids.peaks_keccak, header_with_mmr_starknet.mmr_meta.peaks)";
