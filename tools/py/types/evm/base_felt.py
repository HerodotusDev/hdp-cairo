...
class BaseFelt:
    def _split_word_to_felt(self, value: Union[int, bytes, HexBytes], as_le: bool = False) -> Tuple[int, int]:
        ...
        int_value = int.from_bytes(value, 'big')  # Always interpret bytes as big-endian now
