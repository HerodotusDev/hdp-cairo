...
find ./src ./tests/cairo_programs ./packages/contract_bootloader ./packages/hdp_bootloader/bootloader -name "*.cairo" ! -path "./src/cairo1/*" ! -path "./src/contracts/*" | parallel --halt now,fail=1 process_cairo_file
