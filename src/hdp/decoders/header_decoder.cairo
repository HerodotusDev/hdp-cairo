...
namespace HeaderDecoder {
    func get_coinbase{range_check_ptr, bitwise_ptr: BitwiseBuiltin*, pow2_array: felt*}(
        rlp: felt*
    ) -> felt* {
    ...
    func get_felt_fields_by_index{range_check_ptr, bitwise_ptr: BitwiseBuiltin*, pow2_array: felt*}(
        rlp: felt*, field: felt
    ...
    func get_dynamic_field{range_check_ptr, bitwise_ptr: BitwiseBuiltin*, pow2_array: felt*}(
        rlp: felt*, field: felt, to_be: felt
    ) -> Uint256 {
    ...
    func get_dynamic_field_bytes{range_check_ptr, bitwise_ptr: BitwiseBuiltin*, pow2_array: felt*}(
        ...
        let (res, res_len, bytes_len) = retrieve_from_rlp_list_via_idx(
            rlp=rlp, value_idx=field_idx, item_starts_at_byte=start_byte, counter=0
        );
