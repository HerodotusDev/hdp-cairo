...
use crate::eth_call::utils::helpers::{ceil32, load_word};
...
mod tests {
    ...
    use crate::eth_call::evm::errors::{EVMError, TYPE_CONVERSION_ERROR};
    use crate::eth_call::evm::instructions::EnvironmentInformationTrait;
    ...
    fn test_exec_extcodehash_precompile() {
        ...
        let precompile_evm_address: EthAddress =
            crate::eth_call::evm::precompiles::LAST_ETHEREUM_PRECOMPILE_ADDRESS
            .try_into()
            .unwrap();
        let account = Account {
