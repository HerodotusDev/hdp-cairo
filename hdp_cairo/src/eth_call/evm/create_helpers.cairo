...
use crate::eth_call::evm::model::{
    ExecutionResult, ExecutionResultStatus, ExecutionResultTrait, Message,
};
use crate::eth_call::evm::stack::StackTrait;
use crate::eth_call::evm::state::StateTrait;
use crate::eth_call::utils::address::{compute_contract_address, compute_create2_contract_address};
use crate::eth_call::utils::constants;
use crate::eth_call::utils::helpers::ceil32;
