...
use crate::eth_call::utils::traits::bytes::{FromBytes, ToBytes, U8SpanExTrait};
use crate::eth_call::utils::traits::{BoolIntoNumeric, EthAddressIntoU256, NumericIntoBool};
...
mod tests {
    ...
    use crate::eth_call::evm::precompiles::ec_recover::EcRecover;
    ...
    fn test_ec_recover_precompile() {
        let _msg_hash: u256 = 0x456e9aea5e197a1f1af7a3e85a3212fa4049a3ba34c2289b4c860fc0b0c64ef3;
        let msg_hash = _msg_hash.to_be_bytes_padded();
