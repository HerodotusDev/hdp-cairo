...
pub impl VecIndex<V, T, +VecTrait<V, T>> of Index<V, usize> {
    type Target = T;
...
pub impl DefaultFeltVec<T, +Drop<T>, +Copy<T>, +Felt252DictValue<T>> of Default<Felt252Vec<T>> {
    fn default() -> Felt252Vec<T> {
        Felt252VecImpl::<T>::new()
    }
}

pub impl DestructFeltVec<T, +Drop<T>, +Felt252DictValue<T>> of Destruct<Felt252Vec<T>> {
...
pub impl DestructNullableVec<T, +Drop<T>> of Destruct<NullableVec<T>> {
