...
pub mod transaction;
pub mod tx_type;
use crate::eth_call::utils::errors::{EthTransactionError, RLPErrorImpl};
use crate::eth_call::utils::traits::bytes::ByteArrayExt;
...
#[cfg(test)]
mod tests {
    use crate::eth_call::utils::errors::EthTransactionError;
